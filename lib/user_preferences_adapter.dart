...
class UserPreferencesAdapter extends TypeAdapter<UserPreferences> {
  ...
  void write(BinaryWriter writer, UserPreferences obj) {
    ...
    writer.writeByte(0); writer.write(obj.selectedDistrictId);
    writer.writeByte(1); writer.write(obj.bookmarks);
    writer.writeByte(2); writer.write(obj.notificationsEnabled);
    writer.writeByte(3); writer.write(obj.appLanguage);
    writer.writeByte(4); writer.write(obj.defaultBookId);
  }
}
