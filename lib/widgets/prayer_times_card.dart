      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            FaziletTheme.accentPrimary.withValues(alpha: 0.85),
          ],
                ...
                Row(
                  children: [
                    Container(
                      ...
                      height: 8,
                      decoration: BoxDecoration(
                        color: isNext ? color : color.withValues(alpha: 0.3),
  ...
  Widget _buildFaziletBadge(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: FaziletTheme.accentPrimary.withValues(alpha: 0.15),
        ),
      ),
      child: Row(
        ...
        children: [
          ...
          Flexible(
            child: Text(
              ...
              style: GoogleFonts.lora(
                fontSize: 12,
                color: FaziletTheme.accentPrimary.withValues(alpha: 0.7),
              ),
              overflow: TextOverflow.ellipsis,
            ),
          ),
